...
double qMatrix[6][6], rMatrix[6][6], gammaLR = 0.8;

int max_index[6], available_acts[6];

int ran_top = 0, ran[RAN_LIM];



void printArray(double a[][6])
...
double update(int current_state, int action, double rMatrix[][6],double qMatrix[][6])
...
int available_actions(int state, int available_acts[],double rMatrix[][6])
...

{
    ...
    int initial_state, final_state = 5;

    int current_state, size_av_actions, action;

    double final_max = 0.0, scores[100000], rMatrix[6][6], score = 0.0;
